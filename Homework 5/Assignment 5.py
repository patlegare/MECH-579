...
def main_single_drone():
    ...
    # For inequality g(x) bigger or = 0, a positive value is good.
...
def main_two_drones():
    ...
    plt.plot(x2_init_q3, y2_init_q3,
             linestyle="--", color="magenta", alpha=0.7, label="Drone 2 initial")
